...
import { IconChefHat,  IconMail } from '@tabler/icons';
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-2 gap-2'>
        <div className='flex items-center'>
            ...
            <Link to='/'>
            <h1 className='text-2xl cursor-pointer p-2 duration-200 sm:text-3xl lg:text-4xl  font-thin font-Bakbak'>Me<span className='font-bold font-Bakbak text-red-600'>nu</span>
            </h1>
            </Link>
        </div>
