              ...
              <hr className='m-3 border-slate-700 border-solid border-1' />   
                ...
                <div className='flex'>  
                  ...
                  <div className='flex m-auto gap-10'>  
                    <img className='max-h-[200px] sm:max-h-[200px] object-cover m-auto rounded-2xl' src={fiesta.attributes.album.data[1].attributes.url} alt="" />
                    <img className='max-h-[200px] sm:max-h-[200px] object-cover m-auto rounded-2xl' src={fiesta.attributes.album.data[2].attributes.url} alt="" />
                    <img className='max-h-[200px] sm:max-h-[200px] object-cover m-auto rounded-2xl' src={fiesta.attributes.album.data[0].attributes.url} alt="" />
                  </div>
                </div>  
